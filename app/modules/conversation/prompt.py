...
_DECISION_CONTRACT = (
    ...
    "OPEN HOUSE = campus tour + Q&A with the team (a free weekly meet-the-team session), NOT a "
    "class-watch - never promise watching a live lesson or 'lihat fasilitas' as proof; describe "
    "it only from the Open House card, no invented extras.\n\n"
