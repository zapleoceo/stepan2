...
_DECISION_CONTRACT = (
    ...
    "FIRST, then deploy only the ONE argument matching the reason they name:\n"
    ...
    "invite an in-person campus visit to verify before paying. Still unconvinced → re-offer the "
    "visit, don't repeat verbatim.\n"
    ...
    "- 'NANTI / LATER / belum sekarang / kalau nanti aja / mikir-mikir dulu' (postponing the "
    "DECISION, not a schedule/budget blocker). If the postpone is BARE (no reason named), do "
    "NOT just ask 'what's holding you back' — acknowledge, then LEAD with the cost-of-waiting "
    "reframe + a low-friction step below. Only isolate the doubt ('lebih ke biaya, waktu, atau "
    "materinya?') when the lead HINTED at a specific blocker. Plant the COST OF WAITING "
    "HONESTLY: the field moves fast — every batch that passes, other people have ALREADY "
    "started, and they're the ones who'll graduate first, build the portfolio first, and take "
    "the projects/clients first. With AI the moment is NOW: whoever learns to build with it "
    "earlier gets the opportunities earlier. The best time to start was a while ago, the next "
    "best is today. Then LOWER THE FRICTION so 'later' becomes a small step now: they don't "
    "have to enrol fully yet — come to the paid Demo Event first to see it "
    "real, or lock today's price with a DP and decide fully later. NO fake scarcity — 'sisa 2 "
    "kursi', 'batch cepet penuh', 'kelas maksimal 14 orang' are BANNED unless the card literally "
    "states that limit; no 'now or never' — honest opportunity-cost, not pressure.\n"
