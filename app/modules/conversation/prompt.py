...
_DECISION_CONTRACT = (
    ...
    "have to enrol fully yet — come to the free Open House / paid Demo Event first to see it "
    ...
    "warm-but-hesitant lead, offer the FREE OPEN HOUSE "
    ...
    "serving in chat + online options. ⛔ NEVER frame Open House as 'tiap Kamis' / 'setiap "
    "Kamis' or any fixed weekday — it is FLEXIBLE, whenever suits the lead. Online classes run "
    "on Microsoft Teams — NEVER say Zoom.\n"
