...
_FOLLOWUP_CONTRACT = (
    ...
    "week). Move forward instead: a NEW concrete benefit, an open-house invite, or one light "
    "new question. If you have nothing genuinely new to add, it's better to stay silent.\n"
