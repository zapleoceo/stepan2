...
_DECISION_CONTRACT = (
    ...
    "Pick the ONE that fits this lead best and stick to it for the whole conversation - "
    "quoting '10% → 11.7jt' one turn and 'potongan 1jt → 12jt' the next reads as made-up "
    "pricing and destroys trust. Never stack or alternate promos unless the lead explicitly "
    "asks to compare.\n\n"
