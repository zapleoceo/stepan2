...
_TR: dict[str, dict[str, str]] = {
    ...
    "stg.hint": {"ru": "Колесо с Ctrl — зум, перетаскивание мышью — прокрутка. "
                       "Кнопки слева сверху: приблизить, отдалить, вернуть 1:1.",
                 "en": "Ctrl + wheel to zoom, drag to pan. Buttons top-left: in, out, reset.",
                 "id": "Ctrl + roda untuk zoom, seret untuk geser."},
