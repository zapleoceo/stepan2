...
_TR: dict[str, dict[str, str]] = {
    ...
    "inbox.awaiting_filter": {"ru": "Ждут ответа", "en": "Awaiting reply",
                              "id": "Menunggu balasan"},
    "inbox.await_queue": {"ru": "В очереди на ответ Стёпы", "en": "In Stepan's reply queue",
                          "id": "Antrean balasan Stepan"},
    "inbox.await_off": {"ru": "Без ответа, Стёпа не ответит (менеджер/тихо/старое)",
                        "en": "Unanswered, Stepan won't reply (manager/silent/old)",
                        "id": "Tanpa balasan, Stepan tak balas (manajer/senyap/lama)"},
