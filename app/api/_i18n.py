...
_TR: dict[str, dict[str, str]] = {
    ...
    "inbox.awaiting_filter": {"ru": "Ждут ответа", "en": "Awaiting reply",
                              "id": "Menunggu balasan"},
    "inbox.await_queue": {"ru": "Без ответа, Стёпа включён (ответит)",
                          "en": "Unanswered, Stepan is on (will reply)",
                          "id": "Tanpa balasan, Stepan aktif (akan balas)"},
    "inbox.await_off": {"ru": "Без ответа, Стёпа выключен",
                        "en": "Unanswered, Stepan is off",
                        "id": "Tanpa balasan, Stepan mati"},
