  ...
  <details>
    ...
    <div class="body">
      <ul>
        ...
        <li><b>A question gets an answer, not a counter-question.</b> If the client asks something concrete in their own words ("how much", "which days", "how do I enrol"), the code pins that turn to answering it from the course card first — the follow-up question comes after. Asking someone to "be more specific" or replying "so what's your goal?" to a plain price question is how a live lead is lost, and a prompt rule alone did not hold. The ad's prefilled button text mentions price too, but that is a click, not a question — it still gets the warm-up, never a price.</li>
