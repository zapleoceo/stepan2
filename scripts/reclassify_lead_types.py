...
_SYSTEM = (
    ...
    "no income.\n"
    "- 'student': school-age / a minor - a target segment (not a blocker): any program at a 10% "
    "student discount, a parent pays, can join the adult group. Interested school kids count "
    "here, not as non_target.\n"
